...
# swap below. Canonical source: engine/mount/sync-claudinite.sh at the Claudinite repo.
...
# calling the fetched tree's session-start orchestrator (preferences, active-pack prose, skill
...
# --- mirrored in session-start.sh and engine/checks_helpers/hooklog.mjs — keep the three in
