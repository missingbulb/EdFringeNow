...
import { normPrefix, under } from '../../engine/checks_helpers/paths.mjs';
...
// (`normPrefix`, `under`) live in the engine lib (engine/checks_helpers/paths.mjs) and are
...
// pack-independence extractor, engine/checks_helpers/imports.mjs RELATIVE_SPEC) — which is
