...
import noBranchPushWorkflow from './no-branch-push-workflow.mjs';
...
export default {
  ...
  marker: null,
  prose: 'RULES.md',
  worldRules: [lookupIndices, normalizerSelftestInVerify, dataDirIsGeneratorOutput, noBranchPushWorkflow],
