...
- **Reason:** leaf 1.4 was provable only in code while the product used a native `title` tooltip,
  painted by the browser and invisible to a screenshot; the product then gained a real popup.
- **Actor:** @missingbulb (owner).
- **Model:** Claude Fable 5
- **Mechanism:** a bullet of the "Prefer several pictures over one coded leaf" section in
  `edfringe-requirements`' RULES.md.
