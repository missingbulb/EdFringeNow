...
- **Reason:** the owner's second review pass: the exact copy, counts and placement are what the
  golden already shows, so repeating them in prose only competed with it.
