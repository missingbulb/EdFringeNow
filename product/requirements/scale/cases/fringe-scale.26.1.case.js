...
module.exports = {
  ...
  async verify(page, { origin, assert }) {
    ...
    // The most contested hour on the calendar, by the count its lane names.
    const stacks = await page.$$eval(".sch-rivals", (els) =>
    ...
    await page.locator(".sch-rivals").nth(busiest.i).evaluate((el) => el.click());
    await settle(page);
