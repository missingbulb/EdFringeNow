...
const PAGE_DIR = path.join(__dirname, "..", "..", "..", "..", "site", "planNG");
...
module.exports = {
  ...
  table: TABLE,
  async verify(assert) {
    const { LOCALES, DEFAULT_LOCALE, STRINGS } = await import("../../../../site/planNG/i18n/translations.js");
    const { argumentsOf, pluralCategoriesOf, format } = await import("../../../../site/planNG/i18n/format.js");
