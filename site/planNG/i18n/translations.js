...
export const STRINGS = {
  ...
  "prefs.interests.more": {
    probe: ".pref-word",
    maxWidthPx: 130,
    sample: { count: 16 },
    en: "{count} more kinds",
    he: "{count, plural, one {סוג נוסף} two {עוד שני סוגים} other {עוד # סוגים}}",
    ru: "{count, plural, one {ещё # жанр} few {ещё # жанра} many {ещё # жанров} other {ещё # жанра}}",
    ja: "ほか{count}種類",
  },
  "prefs.interests.all": {
    probe: ".pref-word",
