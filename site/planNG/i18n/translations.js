...
export const STRINGS = {
  ...
  "genre.comedy": { probe: ".tl-card", maxWidthPx: 120, en: "Comedy", he: "קומדיה", ru: "Комедия", ja: "コメディ" },
  ...
  "card.noProgramme": {
    probe: ".tl-card",
    maxWidthPx: 280,
    en: "Programme not published yet",
    he: "התוכנייה עוד לא פורסמה",
    ru: "Программа ещё не опубликована",
    ja: "プログラムは未公開",
  },
  "holiday.weekend": {
    probe: ".tl-card",
    maxWidthPx: 560,
    sample: { name: "Christmas Day · Boxing Day" },
    en: "{name} weekend",
    he: "סופ״ש {name}",
    ru: "{name}: длинные выходные",
    ja: "{name}の連休",
  },
  "holiday.days": {
    probe: ".tl-card",
    maxWidthPx: 200,
    sample: { count: 12 },
    en: "{count, plural, one {# day off} other {# days off}}",
    he: "{count, plural, one {יום חופש אחד} two {יומיים חופש} other {# ימי חופש}}",
    ru: "{count, plural, one {# выходной день} few {# выходных дня} many {# выходных дней} other {# выходного дня}}",
    ja: "{count}日間の休み",
  },
  "holiday.bridge": {
    probe: ".tl-card",
    maxWidthPx: 320,
    sample: { count: 2 },
    en: "{count, plural, one {# work day in the middle} other {# work days in the middle}}",
    he: "{count, plural, one {עם יום עבודה אחד באמצע} two {עם יומיים של עבודה באמצע} other {עם # ימי עבודה באמצע}}",
    ru: "{count, plural, one {# рабочий день посередине} few {# рабочих дня посередине} many {# рабочих дней посередине} other {# рабочего дня посередине}}",
    ja: "間に平日{count}日",
  },
  "holidays.note": {
    probe: ".tl-card",
    ...
    en: "Public holidays in {country}",
    he: "חגים וימי שבתון ב{country}",
    ru: "Праздники: {country}",
    ja: "{country}の祝日",
  },
  "holidays.guess": {
    probe: ".tl-card",
    maxWidthPx: 600,
    sample: { country: "United Kingdom" },
    en: "Public holidays in {country}, our guess from your connection",
    he: "חגים וימי שבתון ב{country}, לפי ניחוש מהחיבור שלכם",
    ru: "Праздники: {country}, по нашей догадке о вашем подключении",
    ja: "{country}の祝日（接続元からの推測）",
  },
  "flight.say": {
    maxWidthPx: null,
    unrendered: "the travel pictures' accessible name and tooltip, in the page's tooltip",
  ...
  "flight.none": {
    ...
    ru: "Вы живёте здесь: ехать никуда не нужно.",
  ...
  "flight.recent": {
    maxWidthPx: null,
    unrendered: "the fare link's explanation, in the page's tooltip, which wraps",
  ...
  "origin.why": {
    maxWidthPx: 1400,
    en: "It decides whether you need a bed, a train or a flight, and we only look up fares if you fly. We ask once, and keep the answer in this browser only.",
    he: "זה קובע אם צריך מיטה, רכבת או טיסה, ומחירי טיסות נחפש רק אם תטוסו. שואלים פעם אחת, והתשובה נשמרת רק בדפדפן הזה.",
    ru: "От этого зависит, нужны ли вам жильё, поезд или самолёт; цены на билеты ищем, только если вы летите. Спрашиваем один раз и храним ответ только в этом браузере.",
    ja: "宿、鉄道、飛行機のどれが必要かが決まります。料金の検索は飛行機のときだけです。一度だけお聞きし、答えはこのブラウザーにのみ保存します。"
  },
  "origin.city": {
    maxWidthPx: 220,
    sample: { city: "Jerusalem" },
  ...
  "perf.tip": {
    maxWidthPx: null,
    unrendered: "a performance mark's explanation, in the page's tooltip, which wraps",
  ...
  "perf.tip.free": {
    maxWidthPx: null,
    unrendered: "a free performance's explanation, in the page's tooltip, which wraps",
  ...
  "prefs.festivals.dayTrip": {
    probe: ".pref-check-word",
    maxWidthPx: 300,
    sample: { km: "3,650" },
    en: "{km} km away · a day trip",
    he: "במרחק {km} ק״מ · טיול של יום",
    ru: "в {km} км · поездка на день",
    ja: "{km} km・日帰り",
  },
  "prefs.festivals.partly": {
    probe: ".pref-check-word",
    maxWidthPx: 300,
    sample: { km: "3,650" },
    en: "{km} km away · some nights",
    he: "במרחק {km} ק״מ · חלק מהערבים",
    ru: "в {km} км · некоторые вечера",
    ja: "{km} km・一部の日程",
  },
  "prefs.festivals.out": {
    probe: ".pref-check-word",
  ...
  "ground.ask": {
    ...
    en: "Airport to town?",
    he: "איך מגיעים לעיר?",
    ru: "Как добраться в город?",
    ja: "空港から街へは？",
  },
  "ground.title": {
    probe: ".keep-label",
    maxWidthPx: 240,
    en: "Between the airport and town",
    he: "בין שדה התעופה לעיר",
    ru: "Между аэропортом и городом",
    ja: "空港と街のあいだ",
  },
  "ground.taxi": {
    probe: ".keep-label",
  ...
  "night.show": {
    maxWidthPx: null,
    unrendered: "the night button's aria-label and tooltip",
  ...
  "travel.walk.tip": {
    maxWidthPx: null,
    unrendered: "the walk button's explanation, in the page's tooltip, which wraps",
  ...
  "travel.bike.tip": {
    maxWidthPx: null,
    unrendered: "the bike button's explanation, in the page's tooltip, which wraps",
  ...
  "travel.car.tip": {
    maxWidthPx: null,
    unrendered: "the car button's explanation, in the page's tooltip, which wraps",
  ...
  "verdict.lock": {
    maxWidthPx: null,
    unrendered: "a verdict button's name, in the page's tooltip and to a screen reader",
    en: "Lock this night",
    he: "נעילת הערב",
    ru: "Закрепить вечер",
    ja: "この夜に確定",
  ...
  "verdict.hint": {
    maxWidthPx: null,
    unrendered: "the popup's first-time hint, which wraps inside the popup",
    en: "Use these to keep the show on this night, favourite it, move it to another night, or drop it.",
    he: "בכפתורים האלה אפשר לקבע את ההופעה לערב הזה, לסמן אותה כמועדפת, להעביר אותה לערב אחר או לוותר עליה.",
    ru: "Этими кнопками можно закрепить шоу на этот вечер, добавить в избранное, перенести на другой вечер или убрать.",
    ja: "このボタンで、この夜に確定、お気に入り、別の夜に変更、この公演をやめる、ができます。",
  },
  ...
  "leg.card.walk": {
    maxWidthPx: null,
    unrendered: "the travel card's words, which wrap inside the card",
    sample: { minutes: 4 },
    en: "Walking {minutes, plural, one {# minute} other {# minutes}}",
    he: "{minutes, plural, one {דקה אחת הליכה} two {שתי דקות הליכה} other {# דקות הליכה}}",
    ru: "Пешком {minutes, plural, one {# минуту} few {# минуты} many {# минут} other {# минуты}}",
    ja: "徒歩{minutes}分",
  },
  "leg.card.bike": {
    maxWidthPx: null,
    unrendered: "the travel card's words, which wrap inside the card",
    sample: { minutes: 4 },
    en: "Cycling {minutes, plural, one {# minute} other {# minutes}}",
    he: "{minutes, plural, one {דקה אחת רכיבה} two {שתי דקות רכיבה} other {# דקות רכיבה}}",
    ru: "На велосипеде {minutes, plural, one {# минуту} few {# минуты} many {# минут} other {# минуты}}",
    ja: "自転車で{minutes}分",
  },
  "leg.card.car": {
    maxWidthPx: null,
    unrendered: "the travel card's words, which wrap inside the card",
    sample: { minutes: 4 },
    en: "Driving {minutes, plural, one {# minute} other {# minutes}}",
    he: "{minutes, plural, one {דקה אחת נסיעה} two {שתי דקות נסיעה} other {# דקות נסיעה}}",
    ru: "На машине {minutes, plural, one {# минуту} few {# минуты} many {# минут} other {# минуты}}",
    ja: "車で{minutes}分",
  },
  "leg.card.from": {
    maxWidthPx: null,
  ...
  "leg.card.spare": {
    maxWidthPx: null,
    unrendered: "the travel card's words, which wrap inside the card",
    sample: { km: "1.4", spare: 20 },
    en: "{km} km. You arrive {spare} min before the next show.",
    he: "{km} ק״מ. מגיעים {spare} דק׳ לפני ההופעה הבאה.",
    ru: "{km} км. Вы на месте за {spare} мин до следующего шоу.",
    ja: "{km}km。次の公演の{spare}分前に着きます。",
  },
  "leg.card.late": {
    maxWidthPx: null,
    unrendered: "the travel card's words, which wrap inside the card",
    sample: { km: "1.4", late: 5 },
    en: "{km} km. You would arrive {late} min after the next show starts.",
    he: "{km} ק״מ. מגיעים {late} דק׳ אחרי שההופעה הבאה מתחילה.",
    ru: "{km} км. Вы опоздаете на следующее шоу на {late} мин.",
    ja: "{km}km。次の公演の開始に{late}分遅れます。",
  },
  "leg.card.same": {
    maxWidthPx: null,
    unrendered: "the travel card's words, which wrap inside the card",
    sample: { gap: 45 },
    en: "No travel: both shows are at {venue}, {gap} min apart.",
    he: "בלי נסיעה: שתי ההופעות ב־{venue}, {gap} דק׳ ביניהן.",
    ru: "Без дороги: оба шоу в {venue}, между ними {gap} мин.",
    ja: "移動なし: どちらも{venue}で、間は{gap}分です。",
  },
  "leg.card.unknown": {
    maxWidthPx: null,
    unrendered: "the travel card's words, which wrap inside the card",
    en: "We can't tell how long the trip takes: a venue has no place on the map.",
    he: "אי אפשר לדעת כמה זמן הדרך לוקחת: לאחד המקומות אין מיקום במפה.",
    ru: "Сколько займёт дорога, неизвестно: у площадки нет места на карте.",
    ja: "移動時間はわかりません: 会場の位置情報がありません。",
  },
  "leg.sameVenue": {
    probe: ".leg-text",
    maxWidthPx: 170,
