...
export const STRINGS = {
  ...
  "period.range": {
    maxWidthPx: 330,
    sample: { range: "17–23 Oct", count: 31 },
    en: "Planning {range} · {count, plural, one {# day} other {# days}}",
    he: "מתכננים {range} · {count, plural, one {יום אחד} two {יומיים} other {# ימים}}",
    ru: "План на {range} · {count, plural, one {# день} few {# дня} many {# дней} other {# дня}}",
    ja: "{range}を計画中 · {count}日間",
  },
  "pool.noProgramme": {
    probe: ".pool-note",
    maxWidthPx: 2000,
