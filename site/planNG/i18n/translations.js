...
export const STRINGS = {
  ...
  "rivals.more": {
    maxWidthPx: null,
    unrendered: "the count's accessible name — on screen it says which of the hour's shows the card is showing",
    sample: { count: 4 },
  ...
  "flip.pick": {
    probe: ".sch-others-full",
    maxWidthPx: 100,
    sample: { count: 48 },
    en: "Our pick of {count}",
    he: "הבחירה שלנו מ־{count}",
    ru: "Наш выбор из {count}",
    ja: "{count}件から厳選",
  },
  "flip.position": {
    probe: ".sch-others-full",
    maxWidthPx: 90,
    sample: { at: 48, count: 48 },
    en: "{at} of {count}",
    he: "{at} מתוך {count}",
    ru: "{at} из {count}",
    ja: "{count}件中{at}",
  ...
  "flip.prev": {
    maxWidthPx: null,
    unrendered: "the step back's accessible name — on screen it is an arrow",
    en: "Previous show at this hour",
    he: "ההופעה הקודמת בשעה הזו",
    ru: "Предыдущее шоу в этот час",
    ja: "この時間の前の公演",
  },
  "flip.next": {
    maxWidthPx: null,
    unrendered: "the step on's accessible name — on screen it is an arrow",
    en: "Next show at this hour",
    he: "ההופעה הבאה בשעה הזו",
    ru: "Следующее шоу в этот час",
    ja: "この時間の次の公演",
  },
  "rivals.title": {
    probe: "#calRivals",
