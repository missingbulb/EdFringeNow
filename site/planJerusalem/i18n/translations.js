...
export const STRINGS = {
  ...
  "rivals.more": {
    probe: ".sch-rivals-btn",
    maxWidthPx: 120,
    sample: { count: 4 },
    en: "+{count} at this hour",
    he: "עוד {count} בשעה הזו",
    ru: "ещё {count} в этот час",
    ja: "この時間に他{count}件",
  },
  "rivals.title": {
    probe: "#calRivals",
  ...
  "preview.onlyNight": {
    probe: "#calPreview",
    maxWidthPx: 260,
    en: "This is its only night.",
    he: "זה הערב היחיד שלה.",
    ru: "Это её единственный вечер.",
    ja: "上演はこの夜だけです。",
  },
  "preview.nights": {
    probe: "#calPreview",
    maxWidthPx: 260,
    sample: { count: 12 },
    en: "Plays {count, plural, one {# night} other {# nights}}.",
    he: "מוצגת {count, plural, one {ערב אחד} two {# ערבים} other {# ערבים}}.",
    ru: "Идёт {count, plural, one {# вечер} few {# вечера} many {# вечеров} other {# вечера}}.",
    ja: "{count}夜の上演です。",
  },
  "preview.drafted": {
    probe: "#calPreview",
  ...
  "verdict.lock": {
    maxWidthPx: null,
    unrendered: "a verdict button's label and tooltip — the button itself draws a mark",
    en: "Lock this night",
    he: "נעילת הערב הזה",
    ru: "Закрепить этот вечер",
    ja: "この夜を確定する",
  },
  "verdict.favourite": {
    maxWidthPx: null,
    unrendered: "a verdict button's label and tooltip — the button itself draws a mark",
    en: "Favourite this show",
    he: "סימון ההופעה כמועדפת",
    ru: "Добавить шоу в избранное",
    ja: "この公演をお気に入りにする",
  },
  "verdict.noTime": {
    maxWidthPx: null,
    unrendered: "a verdict button's label and tooltip — the button itself draws a mark",
    en: "Not this night — another one is fine",
    he: "לא הערב הזה — ערב אחר בסדר",
    ru: "Не в этот вечер — другой подойдёт",
    ja: "この夜はやめる（他の夜なら可）",
  },
  "verdict.noShow": {
    maxWidthPx: null,
    unrendered: "a verdict button's label and tooltip — the button itself draws a mark",
    en: "Not this show, on any night",
    he: "לא ההופעה הזו, באף ערב",
    ru: "Это шоу — ни в какой вечер",
    ja: "この公演はどの夜も見ない",
  },
