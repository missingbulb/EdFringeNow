...
export const STRINGS = {
  ...
  "plan.sub": {
    maxWidthPx: 1700,
    sample: { window: "" },
    en: "The whole programme, drafted across {window}: where several shows want the same hour, the one with the fewest nights takes it. Rule on any of them and the rest re-drafts around you.",
    he: "כל התוכנייה, משובצת על פני {window}: כששתי הופעות רוצות את אותה שעה, זו עם הכי מעט ערבים מקבלת אותה. הכריעו בכל אחת והשאר ישובץ מחדש סביבכם.",
    ru: "Вся программа, собранная на {window}: когда на один час претендуют несколько шоу, его получает то, у которого меньше вечеров. Решите по любому — и остальное пересоберётся вокруг вас.",
    ja: "プログラム全体を{window}に割り当てました。同じ時間に複数の公演が重なるときは、上演夜数のいちばん少ない公演が取ります。どれかを決めれば、残りはそれに合わせて組み直します。",
  },
  ...
  "plan.summary.contested": {
    probe: "#planSummary",
    maxWidthPx: 320,
    sample: { count: 12 },
    en: "{count, plural, one {# hour was contested} other {# hours were contested}}.",
    he: "{count, plural, one {שעה אחת הייתה שנויה במחלוקת} two {# שעות היו שנויות במחלוקת} other {# שעות היו שנויות במחלוקת}}.",
    ru: "{count, plural, one {# час был спорным} few {# часа были спорными} many {# часов были спорными} other {# часа были спорными}}.",
    ja: "{count}つの時間帯で重なりがありました。",
  },
  "plan.prefsLabel": {
    maxWidthPx: null,
